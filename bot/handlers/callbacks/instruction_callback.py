...
async def instruction_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    texts = {
        CallbackData.INSTR_ANDROID: (
            ...
            "   • <a href=\"https://play.google.com/store/search?q=happ+plus&c=apps\">Happ из Google Play</a>\n"
        ...
        CallbackData.INSTR_IOS: (
            ...
            "   • <a href=\"https://apps.apple.com/ru/app/happ-proxy-utility-plus/id6746188973\">Happ из App Store</a>\n"
            "2. В боте нажмите 'Мои подписки' и скопируйте ссылку на подписку.\n"
        ...
        CallbackData.INSTR_WINDOWS: (
            ...
            "   • <a href=\"https://github.com/Happ-proxy/happ-desktop/releases/latest/download/setup-Happ.x64.exe\">Happ для Windows</a>\n"
            "2. В боте нажмите 'Мои подписки' и скопируйте ссылку на подписку.\n"
        ...
        CallbackData.INSTR_MACOS: (
            ...
            "   • <a href=\"https://apps.apple.com/ru/app/happ-proxy-utility-plus/id6746188973?platform=mac\">Happ для Mac</a>\n"
            "2. В боте нажмите 'Мои подписки' и скопируйте ссылку на подписку.\n"
            "3. В выбранном приложении нажмите + → Добавить из буфера обмена.\n"
            "4. Включите профиль (нажмите на переключатель или кнопку 'Включить').\n"
        ...
        CallbackData.INSTR_TV: (
            "<b>Android TV (v2RayTun, Happ)</b>\n"
            "1. Выберите приложение:\n"
            "   • <a href=\"https://play.google.com/store/apps/details?id=com.v2raytun.android\">v2RayTun для Android TV</a>\n"
            "   • <a href=\"https://play.google.com/store/apps/details?id=com.happproxy\">Happ для Android TV</a>\n"
            "2. В боте нажмите 'Мои подписки' и скопируйте ссылку на подписку.\n"
            "3. В выбранном приложении нажмите + → Добавить из буфера обмена.\n"
            "4. Включите профиль (нажмите на переключатель или кнопку 'Включить').\n"
        ...
        CallbackData.INSTR_LINUX: (
            "<b>Linux (Happ)</b>\n"
            "1. <a href=\"https://github.com/Happ-proxy/happ-desktop/releases/latest/download/Happ.linux.x64.deb\">Скачайте Happ для Linux</a>.\n"
            "2. В боте нажмите 'Мои подписки' и скопируйте ссылку на подписку.\n"
