(function () {
    function createPaymentsFeature(deps) {
        ...
        function showPaymentPage() {
            ...
            if (hintEl) {
                if (gw === 'yookassa') hintEl.textContent = 'Оплата откроется на сайте YooKassa в браузере. После оплаты вы вернётесь в приложение — статус проверится автоматически.';
                    ...
                    hintEl.textContent = pgMethod === 'crypto'
                        ? 'Оплата криптой откроется на странице Platega в браузере. После подтверждения статус обновится автоматически.'
                        : 'Оплата через СБП откроется на странице Platega в браузере. После подтверждения статус обновится автоматически.';
                }
